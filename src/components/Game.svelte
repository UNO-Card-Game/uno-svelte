          ...
          <div class="flex-column flex-wrap">
            <div class="top-card-container">
              ...
              <button
                class="nes-btn"
                on:click={drawCard}
                disabled={gameState?.game?.turn !== gameState?.player?.Name}>Draw</button
              >
            </div>
            <div class="cards-section">
              ...
              <div class="cards-container">
                {#each gameState?.player?.Cards as card}
                  <img
              ...
              <h5 style="text-align: center;">Count: {gameState?.player?.Counter}</h5>
            </div>
          </div>
        </div>
      </section>
